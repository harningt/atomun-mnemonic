 ...
 */
class LegacyElectrumServiceSpecification extends Specification {
    MnemonicServiceProvider service = new LegacyElectrumMnemonicService()
    static final def ALG = ElectrumMnemonicAlgorithm.LegacyElectrum
