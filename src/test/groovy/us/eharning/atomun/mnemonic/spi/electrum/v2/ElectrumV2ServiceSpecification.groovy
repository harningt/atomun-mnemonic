 ...
 */
class ElectrumV2ServiceSpecification extends Specification {
    MnemonicServiceProvider service = new ElectrumV2MnemonicService()
    static final def ALG = ElectrumMnemonicAlgorithm.ElectrumV2
