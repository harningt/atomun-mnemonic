...
import us.eharning.atomun.mnemonic.spi.electrum.v2.MnemonicIndexGenerator
import us.eharning.atomun.mnemonic.spi.electrum.v2.MnemonicUtility
...
/**
 * Test sequence for the BIP0039 mnemonic utility classes
 */
class BIP0039UtilityChecks extends Specification {
    def "MnemonicUtility is a utility class"() {
        when:
        UtilityClassTestUtil.assertUtilityClassWellDefined(BIP0039MnemonicUtility)
        then:
        noExceptionThrown()
    }
